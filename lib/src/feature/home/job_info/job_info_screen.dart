                          ...
                          children: [
                            ...
                            Container(
                                ...
                                child: ListView.builder(
                                    ...
                                    itemCount: _vm
                                        .jobDetail["typesOfJob"]
                                        .length,
                                    padding: EdgeInsets.zero,
                                    itemBuilder:
                                        (BuildContext ctx, int i) {
                                      var typesOfJob = _vm
                                          .jobDetail["typesOfJob"][i];
                                      return Padding(
                            ...
                            Container(
                                ...
                                child: ListView.builder(
                                    scrollDirection: Axis.horizontal,
                                    itemCount: _vm
                                        .jobDetail["language"].length,
                                    padding: EdgeInsets.zero,
                                    itemBuilder:
                                        (BuildContext ctx, int i) {
                                      var language = _vm
                                          .jobDetail["language"][i];
                                      return Padding(
                                          padding: EdgeInsets.only(
                                              right: 8.0),
                                          child: CommonChip(
