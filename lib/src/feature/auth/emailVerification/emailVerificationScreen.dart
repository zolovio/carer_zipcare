...
import 'package:zip_care/src/feature/auth/emailVerification/emailVm.dart';
              ...
              child: FormBuilder(
                  ...
                  child: Column(children: [
                    const CommonAppBarWithBack(
                        title: "Email Verification", isBackActive: true),
                    SizedBox(height: size.height * 0.1),
                    imageAsset(otpIllus2,
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      Text("$secondsRemaining",
                          style:
                              textStyleMedium(color: AppColors.darkPinkColor))
                    ]),
