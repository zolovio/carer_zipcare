              ...
              child: Column(
                  ...
                  children: [
                    ...
                    ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int i) {
                          ...
                          return JobtypeRadio(
                              ...
                              onChange: (e) => _vm.updateJobType(e),
                              subTitle: item.value);
                        }),
                    ...
                    RadioListTile(
                        ...
                        onChanged: (v) => _vm.updateBusinessType(v!),
                        selected: strSoleTrader == _vm.businessType,
                        activeColor: AppColors.darkPinkColor),
                    ...
                    RadioListTile(
                        ...
                        onChanged: (v) => _vm.updateBusinessType(v!),
                        selected: strLTDCompany == _vm.businessType,
                        activeColor: AppColors.darkPinkColor),
                    ...
                    RadioListTile(
                        ...
                        onChanged: (v) => _vm.updateBusinessType(v!),
                        selected: strLLPCompany == _vm.businessType,
                        activeColor: AppColors.darkPinkColor),
                    ...
                    RangeSlider(
                        ...
                        onChanged: (values) =>
                            _vm.updateRange(values, isHour: false),
                        min: 0,
                        max: 20),
                    Row(
                      mainAxisAlignment:
